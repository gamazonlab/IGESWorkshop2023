...
❗️It happens here, that many of the genes are evenly expressed across samples. In the case that DEG results are dominated by a single sample, one approach is to use "downsample" Seurat function to make sure that every sample has the same number of cells.
